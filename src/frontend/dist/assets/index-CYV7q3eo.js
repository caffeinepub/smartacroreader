...
const Crop = createLucideIcon("crop", __iconNode$l);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Merge = createLucideIcon("merge", __iconNode$e);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Stamp = createLucideIcon("stamp", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const annotateTools = [
  {
    id: "highlight",
    label: "Highlight",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Highlighter, { size: 14 }),
    description: "Highlight text in the PDF. Click and drag over text to apply."
  },
  {
    id: "comment",
    label: "Comment",
  ...
  },
  {
    id: "underline",
    label: "Underline",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Underline, { size: 14 }),
    description: "Underline selected text in the document."
  },
  {
    id: "draw",
    label: "Draw",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PenTool, { size: 14 }),
    description: "Freehand drawing tool — draw shapes and markups on the PDF."
  },
  {
    id: "stamp",
    label: "Stamp",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Stamp, { size: 14 }),
...
const editTools = [
  {
    id: "editText",
    label: "Edit Text",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Type, { size: 14 }),
    description: "Click on any text to edit it directly within the PDF."
  },
  {
    id: "crop",
    label: "Crop Pages",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Crop, { size: 14 }),
  ...
  },
  {
    id: "rotate",
    label: "Rotate",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCw, { size: 14 }),
...
const organizeTools = [
  {
    id: "split",
    label: "Split PDF",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Scissors, { size: 14 }),
  ...
  },
  {
    id: "merge",
    label: "Merge PDF",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Merge, { size: 14 }),
...
const convertTools = [
  {
    id: "compress",
    label: "Compress",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Minimize2, { size: 14 }),
  ...
  },
  {
    id: "toWord",
    label: "To Word",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileDown, { size: 14 }),
  ...
  },
  {
    id: "toExcel",
    label: "To Excel",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileSpreadsheet, { size: 14 }),
  ...
  },
  {
    id: "toPPT",
    label: "To PPT",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Presentation, { size: 14 }),
...
function ToolButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      onClick,
      className: `flex items-center gap-2 w-full px-3 py-1.5 rounded text-sm transition-colors ${active ? "bg-[oklch(0.55_0.22_25)] text-white" : "text-[oklch(0.75_0.01_270)] hover:bg-[oklch(0.22_0.03_270)] hover:text-white"}`,
      children: [
        tool.icon,
        tool.label
      ]
...
function ToolSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-1 text-[10px] font-semibold uppercase tracking-widest text-[oklch(0.50_0.015_270)]", children: title }),
...
function ProcessingModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[oklch(0.17_0.025_270)] border border-[oklch(0.25_0.02_270)] rounded-lg p-6 w-80 shadow-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-white font-semibold", children: [
            tool.icon,
            tool.label
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[oklch(0.70_0.01_270)] mb-5", children: tool.description }),
...
function App() {
  ...
  const [modalTool, setModalTool] = reactExports.useState(null);
  ...
  const handleFiles = reactExports.useCallback(
    (fileList) => {
      ...
      if (newFiles.length === 0) {
        ue.error("Please select PDF files only.");
        return;
      }
      setFiles((prev) => {
  ...
  const handleTool = reactExports.useCallback(
    (toolId) => {
      const allTools2 = [
        ...annotateTools,
        ...editTools,
      ...
      const tool = allTools2.find((t) => t.id === toolId);
      if (tool.modal) {
        if (!activeFile) {
          ue.error("Open a PDF first.");
          return;
        }
        setModalTool(tool);
        setActiveTool(null);
        ...
        setActiveTool(next);
        if (next) ue.success(`${tool.label} tool active`);
      }
    },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen bg-[oklch(0.14_0.03_270)] text-white select-none overflow-hidden", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded bg-[oklch(0.55_0.22_25)] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 11, className: "text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold tracking-tight", children: "SmartAcroReader" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 w-px bg-[oklch(0.25_0.02_270)]" }),
            ["File", "Edit", "View", "Tools", "Help"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                type: "button",
                onClick: () => setZoom((z2) => Math.max(50, z2 - 10)),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-[oklch(0.70_0.01_270)] w-10 text-center", children: [
              zoom,
              "%"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                type: "button",
                onClick: () => setZoom((z2) => Math.min(300, z2 + 10)),
                className: "w-6 h-6 flex items-center justify-center rounded hover:bg-[oklch(0.22_0.025_270)] text-[oklch(0.70_0.01_270)] hover:text-white transition-colors",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "aside",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 border-b border-[oklch(0.22_0.02_270)]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
              ...
              "div",
              {
                ...
                children: files.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `flex items-center gap-2 w-full px-3 py-2 text-left text-xs truncate transition-colors ${f.id === activeFileId ? "bg-[oklch(0.22_0.03_270)] text-white border-l-2 border-[oklch(0.55_0.22_25)]" : "text-[oklch(0.70_0.01_270)] hover:bg-[oklch(0.20_0.025_270)] hover:text-white"}`,
                    "data-ocid": `file.item.${i + 1}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 12, className: "shrink-0" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-1 pt-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ToolSection,
                {
                  title: "Annotate",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "main",
        {
          ...
          children: [
            dragging && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-medium", children: "Drop PDFs here" })
                ] })
              }
            ),
            activeFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-full flex flex-col", children: [
              activeToolInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-[oklch(0.55_0.22_25)] font-medium", children: [
                      activeToolInfo.icon,
                      activeToolInfo.label,
                      " active"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[oklch(0.60_0.01_270)]", children: activeToolInfo.description }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "object",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full text-[oklch(0.60_0.01_270)]", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 48, className: "mb-4 opacity-40" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Your browser does not support embedded PDFs." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                        href: activeFile.url,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        "data-ocid": "viewer.dropzone",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-[oklch(0.55_0.22_25/0.15)] flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { size: 24, className: "text-[oklch(0.55_0.22_25)]" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold mb-1", children: "Open a PDF to get started" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-[oklch(0.55_0.015_270)]", children: "Drag & drop or click to browse" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              type: "button",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 max-w-2xl w-full", children: featureCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: "bg-[oklch(0.17_0.025_270)] border border-[oklch(0.22_0.02_270)] rounded-lg p-4",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[oklch(0.55_0.22_25)] mb-2", children: card.icon }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white text-xs font-semibold mb-1", children: card.title }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-[oklch(0.55_0.015_270)] leading-relaxed", children: card.desc })
                        ]
                      },
                      card.title
                    )) })
    ...
    modalTool && /* @__PURE__ */ jsxRuntimeExports.jsx(ProcessingModal, { tool: modalTool, onClose: () => setModalTool(null) }),
